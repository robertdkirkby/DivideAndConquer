function F=LifeCycleModel10_ReturnFn(aprime,a,w,sigma,agej,Jr,pension,r,kappa_j,warmglow1,warmglow2,warmglow3,beta,sj)
...
if agej<Jr % If working age
    c=w*kappa_j+(1+r)*a-aprime; % z is stochastic endowment
else % Retirement
