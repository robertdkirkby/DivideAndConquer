...
vfoptions=rmfield(vfoptions,'divideandconquer');
vfoptions=rmfield(vfoptions,'level1n');
timedc1=toc

tic;
[V2, Policy2]=ValueFnIter_Case1_FHorz(0,n_a,n_z,N_j, [], a_grid, z_grid_J, pi_z_J, ReturnFn, Params, DiscountFactorParamNames, [], vfoptions);
